...
cisco_device = {
    ...
    'fast_cli': False,        # belangrijk voor seriële verbindingen
}
...
def main():
    ...
    try:
        ...
        # Get both Genie-parsed AND raw text output
        ...
        with open(CSV_FILENAME, 'a', newline='') as csv_file:
            writer = csv.writer(csv_file, quoting=csv.QUOTE_ALL)  # quoting prevents comma-in-value splits
            if not file_exists:
